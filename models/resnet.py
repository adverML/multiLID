...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=100,  preprocessing={}):
...
def resnet34(num_classes=4, preprocessing={}):
    """ return a ResNet 34 object
    """
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes, preprocessing)
