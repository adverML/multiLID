...
class WideResNet(nn.Module):
    ...
    def __init__(self, num_classes, block, depth=50, widen_factor=1, dropout=0.3, preprocessing={}):
        super().__init__()
    ...
    def _make_layer(self, block, out_channels, num_blocks, stride):
        ...
        for stride in strides:
            layers.append(block(self.in_channels, out_channels, stride, self.dropout))
...
def wideresnet(num_classes=100, depth=40, widen_factor=10):
    net = WideResNet(num_classes, WideBasic, depth=depth, widen_factor=widen_factor, dropout=0.3)
    return net
